...
class Season extends StatefulWidget {
  ...
  const Season({Key key, this.seasonName}) : super(key: key);
  @override
...
class _Season extends State<Season> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _getOfferPageBody(context, widget.seasonName),
    );
  }
  ...
  Widget _getOfferPageBody(BuildContext context, String offer) {
    ...
    return FutureBuilder(
        future: DataCollection().getProductsCollectionBySeasonType(offer),
