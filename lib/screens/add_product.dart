...
class _AddProductState extends State<AddProduct> {
  ...
  List<DropdownMenuItem<String>> getCategoriesDropdown(){
    ...
    for(int i = 0; i < categories.length; i++){
      setState(() {
        items.insert(0, DropdownMenuItem(child: Text(categories[i].get('category')),
  ...
  List<DropdownMenuItem<String>> getBrandosDropDown(){
    ...
    for(int i = 0; i < brands.length; i++){
      setState(() {
        items.insert(0, DropdownMenuItem(child: Text(brands[i].get('brand')),
...
//
    ...
    if(_formKey.currentState.validate()){
      if(_image1 != null && _image2 != null && _image3 != null){
        //if(selectedSizes.isNotEmpty){
          ...
          StorageReference firebaseStorageRef = FirebaseStorage.instance.ref().child(picture);
  ...
  void _addProductToDB(String url) {
    print(productNameController.text);
    _productService.addProducts(productNameController.text, _currentCategory,
     null, true, int.parse(quatityController.text),
        productNameController.text, url, 100, _currentBrand, true, 4.5, "red");
  }
}